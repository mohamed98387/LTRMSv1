...
import { Table, SearchResult } from './agence-list.model';
import { tableData } from './data-agence';
import { SortDirection } from './agence-list.directive';
...
function matches(tables: Table, term: string, pipe: PipeTransform) {
  return tables.Email.toLowerCase().includes(term.toLowerCase())
