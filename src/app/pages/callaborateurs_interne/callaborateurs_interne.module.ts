...
@NgModule({
  ...
  declarations: [AddSegmentComponent, SegmentListComponent, EditSegmentComponent, AddEmployesComponent, EditEmployesComponent, EmployesListComponent, CircuitListComponent, AddCircuitComponent, EditCircuitComponent, StationListComponent, AddStationComponent, EditStationComponent],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
